...
# E-mail Setting
SEND_EMAIL_ADDRESS = os.getenv('YINGLONG_SEND_EMAIL_ADDRESS',
                               "YOUR_SEND_EMAIL_ADDRESS")
SEND_EMAIL_PASSWORD = os.getenv('YINGLONG_SEND_EMAIL_PASSWORD',
                                "YOUR_SEND_EMAIL_PASSWORD")
...
MYSQL_TEST_DATABASE = os.getenv('YINGLONG_MYSQL_TEST_DATABASE',
                                'YOUR_MYSQL_TEST_DATABASE')
MYSQL_PRO_DATABASE = os.getenv('YINGLONG_MYSQL_PRO_DATABASE',
                               'YOUR_MYSQL_PRO_DATABASE')
MYSQL_DATABASE = os.getenv('YINGLONG_MYSQL_TEST_DATABASE',
                           'YOUR_MYSQL_DATABASE')
DB_URL = 'mysql+pymysql://{}:{}@{}'.format(MYSQL_USERNAME,
                                           urlquote(MYSQL_PASSWORD),
                                           MYSQL_DATABASE)
DB_PRO_URL = 'mysql+pymysql://{}:{}@{}'.format(MYSQL_USERNAME,
                                               urlquote(MYSQL_PASSWORD),
                                               MYSQL_PRO_DATABASE)
DB_TEST_URL = 'mysql+pymysql://{}:{}@{}'.format(MYSQL_USERNAME,
                                                urlquote(MYSQL_PASSWORD),
                                                MYSQL_TEST_DATABASE)
...
class BaseConfig(object):
    SECRET_KEY = os.getenv('YINGLONG_SECRET_KEY',
                           'Yinglong Project copyright Redflag Organization')
    ITEMS_PER_PAGE = 10
