...
def sendEmail(title: str, content: str, receivers: list, attach: str) -> None:
    ...
    message['From'] = Header("开源情报机器人", 'utf-8')  # 发送者
    message['To'] = Header("订阅者", 'utf-8')  # 接收者
    message.attach(text)
...
if __name__ == '__main__':
    sendEmail('hello', 'world', ['admin@example.com'], None)
